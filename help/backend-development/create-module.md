...
4. Um das Modul zu registrieren und zu installieren, führen Sie `bin/magento setup:upgrade` aus.
...
* Vermeiden Sie `around`. Sie mögen bequem erscheinen, stellen jedoch häufig die falsche Wahl dar und verursachen Leistungsprobleme.
