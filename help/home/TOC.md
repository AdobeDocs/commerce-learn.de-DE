...
+ Adobe Commerce Cloud {#adobe-commerce-cloud}
   + Fehlerbehebung {#troubleshooting}
      ...
      + [2 häufige Site-Fehler testen und beheben](../cloud/troubleshooting/triage-two-common-site-errors.md)
...
+ Erste Schritte {#getting-started}
   + Migration zu Adobe Commerce{#migrating-to-adobe-commerce}
      ...
      + Vorbereitung{#preparation}
         + [Bewerten des Teams und Projekts](../migrating-to-adobe-commerce/preparation/evaluate-team-and-project.md)
      + Anpassungen{#customizations}
         + [In-Process-Codestandards](../migrating-to-adobe-commerce/customizations/in-process-code-standards.md)
      + QA{#qa}
   ...
   + Starterkit für Back Office-Integration {#back-office-integration-starter-kit}
      ...
      + [Letzte Meilenintegration](../back-office-integrations/last-mile-integration.md)
      + [Webhook-Erfassung](../back-office-integrations/webhook-ingestion.md)
      + [Wiederholungsmechanismus](../back-office-integrations/retry-mechanism.md)
   + Hilfe und Support {#help-and-support}
      + [Support-Ticket erstellen](../help-and-support/create-a-support-ticket.md)
      ...
      + [Hinzufügen und Entfernen von Beobachtern, Schließen und erneutes Öffnen eines Tickets](../help-and-support/add-remove-watchers-close-reopen-support-ticket.md)
...
+ Store Administration {#admin}
   ...
   + [Zurücksetzen des Admin-URI](../site-management/reset-admin-uri.md)
   + [Versand- und Bereitstellungsmethoden](../site-management/shipping-delivery.md)
   + [Admin Grids und Filter](../site-management/admin-grids-and-filters.md)
...
+ Tools und externe Dienste {#tools}
   ...
   + New Relic {#new-relic}
      ...
      + [Warnhinweiserstellung](../new-relic/new-relic-alert-notification-setup.md)
