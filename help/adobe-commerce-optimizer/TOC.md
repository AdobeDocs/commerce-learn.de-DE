...
+ [Erstellen der ersten Instanz von Adobe Commerce Optimizer](./create-first-instance.md)
+ [Verwalten von Adobe Commerce Optimizer-Instanzen](./managing-instances.md)
+ [Aufnehmen von Beispieldaten](./ingest-sample-data.md)
+ [Erste Abfrage mit GraphQL](./first-query.md)
+ Salesforce Commerce Cloud Starter Kit {#sfcc-starter-kit}
   + [Überblick](./sfcc-starter-kit/overview.md)
   + [Überblick über die Architektur](./sfcc-starter-kit/architecture-overview.md)
   + [Installation der SFCC-Patrone](./sfcc-starter-kit/installation-sfcc-cartridge.md)
