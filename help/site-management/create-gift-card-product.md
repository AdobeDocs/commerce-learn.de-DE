...
description: Erfahren Sie, wie Sie ein Geschenkkartenprodukt mit der REST-API und dem Commerce Admin erstellen.
kt: 14587
doc-type: video
audience: all
activity: use
...
- [Erstellen Sie ein Geschenkkarteprodukt vom Commerce Admin](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/types/product-gift-card-create.html){target="_blank"}
